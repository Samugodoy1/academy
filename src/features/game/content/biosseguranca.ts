...
export const BIO_EXERCISES: ExerciseSeed[] = [
  ...
  },
  {
    ...
    sentence: 'A autoclave esteriliza materiais compatíveis por meio de ___ saturado sob pressão.',
    answer: 'vapor',
    bank: ['vapor', 'álcool', 'radiação ultravioleta', 'detergente'],
    explanation: 'O vapor saturado sob pressão transfere calor e destrói microrganismos, inclusive esporos, quando tempo, temperatura, remoção de ar e secagem estão adequados.',
  },
  {
    id: 'bio-08',
    kind: 'order',
    difficulty: 2,
    prompt: 'Ordene o processamento de um instrumental crítico reutilizável',
    steps: [
      'Transportar o instrumental contaminado em recipiente fechado e resistente',
      'Limpar o instrumental com método seguro e validado',
      'Enxaguar, secar e inspecionar limpeza e integridade',
      'Embalar e identificar em sistema compatível com a esterilização',
      'Esterilizar no ciclo indicado e verificar os controles do processo',
      'Armazenar a embalagem íntegra em local limpo e seco',
    ],
    explanation: 'Resíduos comprometem a esterilização; por isso, a limpeza precede inspeção, embalagem e ciclo. A liberação e o armazenamento dependem da integridade da embalagem e do monitoramento do processo.',
  },
  {
    id: 'bio-09',
    kind: 'match',
    difficulty: 2,
    prompt: 'Relacione o item com sua classificação de processamento',
    pairs: [
      { left: 'Fórceps de extração', right: 'Artigo crítico' },
      { left: 'Espelho bucal reutilizável', right: 'Artigo semicrítico' },
      { left: 'Manguito do esfigmomanômetro', right: 'Artigo não crítico' },
      { left: 'Agulha anestésica', right: 'Perfurocortante descartável de uso único' },
    ],
    explanation: 'Artigos críticos e semicríticos termorresistentes devem ser esterilizados; não críticos recebem limpeza e desinfecção conforme contaminação. Agulhas não são reprocessadas e vão diretamente ao coletor apropriado.',
  },
];
