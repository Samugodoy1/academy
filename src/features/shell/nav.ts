import { BookOpen, Calendar, GraduationCap, Home, User, Users } from '../../icons';

export const ACADEMY_NAV = [
  { id: 'dashboard', label: 'Hoje', short: 'Hoje', description: 'O seu dia', icon: Home },
  { id: 'base', label: 'Estudos', short: 'Estudos', description: 'Ciclo básico', icon: GraduationCap },
  ...
  { id: 'estudos', label: 'Cola', short: 'Cola', description: 'Antes de sentar', icon: BookOpen },
