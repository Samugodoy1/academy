  ...
  try {
    await query(`
      ...
      CREATE TABLE IF NOT EXISTS patients (
        ...
        product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy')),
        name TEXT NOT NULL,
        cpf TEXT UNIQUE,
        birth_date DATE,
        phone TEXT,
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='patients' AND column_name='product') THEN
          ALTER TABLE patients ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='appointments' AND column_name='product') THEN
          ALTER TABLE appointments ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      END $$;
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='clinical_evolution' AND column_name='product') THEN
          ALTER TABLE clinical_evolution ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='patient_files' AND column_name='product') THEN
          ALTER TABLE patient_files ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='tooth_history' AND column_name='product') THEN
          ALTER TABLE tooth_history ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      END $$;
      ...
      DO $$ 
      BEGIN 
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='documents' AND column_name='product') THEN
          ALTER TABLE documents ADD COLUMN product TEXT NOT NULL DEFAULT 'odontohub' CHECK (product IN ('odontohub', 'academy'));
        END IF;
      END $$;
      ...
      SELECT 'Administrador', 'admin@clinica.com', '$2b$10$xmKx.ecGx.GrjknXd7DsDu78Uv9SQtQTjti37zB7Ljdam8QCeqQcm', 'ADMIN', 'active'
    ...
    const validHash = '$2b$10$xmKx.ecGx.GrjknXd7DsDu78Uv9SQtQTjti37zB7Ljdam8QCeqQcm';
    await query(
      `UPDATE users SET password = $1
       WHERE email = 'admin@clinica.com'
       AND password IN (
         '$2a$10$7f8f8f8f8f8f8f8f8f8f8uY/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/Y/',
         '$2a$10$vI8aWBnW3fID.99Y.99Y.99Y.99Y.99Y.99Y.99Y.99Y.99Y.99Y.'
       )`,
      [validHash]
    );
