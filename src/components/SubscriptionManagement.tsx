...
export function SubscriptionManagement({ apiFetch, product, currentPlan }: SubscriptionManagementProps) {
  ...
  if (loading) {
    return (
      <div className={product === 'academy' ? 'ah-card p-5' : 'bg-white rounded-3xl border border-slate-100 shadow-sm p-6'}>
  ...
  return (
    <div className="space-y-4">
      <div className={neo ? 'overflow-hidden ah-card' : 'bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden'}>
        {!neo && (
